...
## OUTPUT
![image](https://github.com/user-attachments/assets/9ef01271-b720-4cf6-a408-23edee5aef67)


## RESULT
Thus, The Python function `def insert(self, k):` to insert the nodes in a **B-Tree** was implemented and executed successfully.
