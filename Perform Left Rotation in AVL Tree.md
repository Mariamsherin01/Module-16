...
## OUTPUT
![image](https://github.com/user-attachments/assets/ac72a737-96cc-4952-9461-4f0a73820998)


## RESULT
Thus, The Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element '7' into it was implemented and executed successfully.
